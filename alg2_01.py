# -*- coding: utf-8 -*-
"""
Created on Tue Feb 25 14:49:55 2020
...
for t in range(30):
    ...
    #alpha = 0.2
    #10% of variance
    if E_state[0,0] == 0 or E_state[0,1] == 0:
        print("E_state[0,0] or E_state[0,1] is 0")
    else:
        if E_state[1,0] < E_state[0,0]:
            print("E_state[1,0] < E_state[0,0]")
        else:
            if E_state[1,1] > E_state[0,1]:
